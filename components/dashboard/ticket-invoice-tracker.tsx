...
import { Check, ClipboardList, Plus, ShieldCheck } from "lucide-react"
...
export function TicketInvoiceTracker() {
  ...
  const submitTicket = async () => {
    if (!activeCompanyId) return
    await createTicket({ companyId: activeCompanyId, ...form })
