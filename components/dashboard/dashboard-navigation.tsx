...
export function DashboardNavigation() {
  ...
  return (
    <>
      ...
      <aside className={cn("fixed inset-y-0 left-0 z-50 flex w-64 shrink-0 flex-col border-r border-sidebar-border bg-sidebar px-4 py-6 shadow-xl transition-transform lg:sticky lg:top-0 lg:z-30 lg:h-screen lg:translate-x-0 lg:shadow-none", open ? "translate-x-0" : "-translate-x-full")}>
        ...
        <nav aria-label="Dashboard options" className="flex flex-1 flex-col gap-1 overflow-y-auto">
