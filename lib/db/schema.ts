...
export const incident = pgTable('incident', {
  ...
  immediateCauses: text('immediate_causes'),
  rootCauses: text('root_causes'),
  latentFailures: text('latent_failures'),
  dataGathering: text('data_gathering'),
  detailedObservations: text('detailed_observations'),
  interviewNotes: text('interview_notes'),
  evidenceDescription: text('evidence_description'),
  findings: text('findings'),
  additionalComments: text('additional_comments'),
  dataGatheringAttachment: text('data_gathering_attachment'),
  dataGatheringAttachmentName: text('data_gathering_attachment_name'),
